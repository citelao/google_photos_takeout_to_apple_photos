...
export interface ContentIdentifiersOutput {
    SourceFile: string;
    ContentIdentifier: string | undefined;
}
export async function getContentIdentifiersForDirectory(dirPath: string): Promise<Array<ContentIdentifiersOutput>> {
    const PRECISION = 6;
